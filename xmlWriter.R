...
st_crs(shp_filtered) <- crs_final
warning(paste("Make sure that the input shapefile's crs was EPSG: ", crs_final, " originally", sep = ""))
...
elevation_crs <- projectRaster(elevation, crs = st_crs(shp_filtered, asText = TRUE))
