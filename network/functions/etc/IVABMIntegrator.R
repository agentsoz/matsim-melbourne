...
xml.file.URL <- "./generatedNetworks/GMel_2D_NoPT_GMel_20m_MATSimCleanedCar_v010.xml.gz"
...
exportXML(total.links, total.nodes, outputFileName = "GMel_2D_IVABMPT_GMel_20m_MatsimCleanedCar_pnrAdded_v010", addZ_coord = F)
