...
networkSimplication <- TRUE # change to false if you don't want to simplify the network
...
saveXML(xml, paste( oneDriveURL, "/Data/processedSpatial/melbourne/melbourne_v15.XML", sep = "" ), encoding="utf-8", 
        prefix = xml_prefix)
