...
elevation <- raster(paste(data_folder, "DEMs/DEMx10EPSG28355.tif", sep = "")) 
...
if (write_sqlite) {
  exportSQlite(lines_np, nodes_np, outputFileName = "outputSQlite")
}

if (write_xml) {
  exportXML(lines_np, nodes_np, outputFileName = "outputSQlite")
}
