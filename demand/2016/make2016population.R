...
setup<-function() {
  ...
  echo(paste0('Wrote markov chain model visualisation to ', pdffile, '\n'))
  echo('Setup complete.\n')
}
...
# script parameters
options(scipen=999)
sampleSize<- 0.0001 # in percent where 1% is approx 40k persons
outfileprefix<-paste0('mel2016_',sampleSize)
